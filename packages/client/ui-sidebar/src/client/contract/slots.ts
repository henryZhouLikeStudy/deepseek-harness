...
declare module '@deepseek-ai/dsh-client-ui-slots' {
  interface SlotMap {
    ...
    /**
     * The lattice room browser: group-chat rooms over the official subagent seam.
     * Declared by this package's 'sidebar' entry; ui-lattice-room registers the
     * browser and receives the same column owner share as workspaces.
     */
    'sidebar.latticeRooms': { kind: 'single'; scope: 'root'; owner: SidebarSectionOwnerProps }
    /**
...
export type SidebarRootComponentProps =
  ...
  & PropsRenderSlots<'sidebar.workspaces' | 'sidebar.latticeRooms' | 'sidebar.settings' | 'sidebar.footer.action'>
